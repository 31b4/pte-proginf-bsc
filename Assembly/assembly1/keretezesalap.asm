...
main PROC
    ...
    draw_top:
        ...
        ADD DI, 2
        CMP DI, 160   ; A képernyő egy sorának hossza (80 karakter * 2 byte/karakter)
        JL draw_top

     MOV DI, 0
    draw_left:
        MOV ES:[DI], AX ; Karakter beírása a képernyő-memóriába
        ADD DI, 160   ; Ugrás a következő sor elejére
        CMP DI, 4000  ; A képernyő teljes hossza (25 sor * 80 karakter * 2 byte/karakter)
        JL draw_left
    ...
    MOV ES:[DI], AX ; Karakter beírása a képernyő-memóriába
    SUB DI, 2
    CMP DI, 4000 - 160 ; Az utolsó sor első karakteréig menjen (4000 - 320)
    JGE draw_bottom
